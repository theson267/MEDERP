...
{
    public class NS_KPI_U_ITEMFactory
    {

        #region data Members

        NS_KPI_U_ITEMSql _dataObject = null;

        #endregion

        #region Constructor

        public NS_KPI_U_ITEMFactory()
        {
            _dataObject = new NS_KPI_U_ITEMSql();
        }
        ...
        /// <summary>
        /// Insert new NS_KPI_U_ITEM
        /// </summary>
        /// <param name="businessObject">NS_KPI_U_ITEM object</param>
        ...
        /// <summary>
        /// get NS_KPI_U_ITEM by primary key.
        /// </summary>
        /// <param name="keys">primary key</param>
        /// <returns>Student</returns>
        public NS_KPI_U_ITEM GetByPrimaryKey(NS_KPI_U_ITEMKeys keys)
        {
            return _dataObject.SelectByPrimaryKey(keys); 
        }

        /// <summary>
        /// get list of all NS_KPI_U_ITEMs
        /// </summary>
        /// <returns>list</returns>
        public List<NS_KPI_U_ITEM> GetAllForList()
        {
        ...
        /// <summary>
        /// get list of NS_KPI_U_ITEM by field
        /// </summary>
        /// <param name="fieldName">field name</param>
        /// <param name="value">value</param>
        /// <returns>list</returns>
        public List<NS_KPI_U_ITEM> GetAllByForList(NS_KPI_U_ITEM.NS_KPI_U_ITEMFields fieldName, object value)
        {
            return _dataObject.SelectByFieldForList(fieldName.ToString(), value);  
        }
        public DataTable GetAllBy(NS_KPI_U_ITEM.NS_KPI_U_ITEMFields fieldName, object value)
        {
        ...
        public bool Delete(NS_KPI_U_ITEM.NS_KPI_U_ITEMFields fieldName, object value)
        {
            return _dataObject.DeleteByField(fieldName.ToString(), value); 
        }
//HaDaiCa
        public bool Delete(NS_KPI_U_ITEM.NS_KPI_U_ITEMFields fieldName, object value,SqlConnection cnn,SqlTransaction trans)
        {
